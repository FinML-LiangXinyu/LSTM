...
$i_t=\sigma\left(U_ih_{t-1}+W_ix_t+b_i\right)$

$f_t=\sigma\left(U_fh_{t-1}+W_fx_t+b_f\right)$

$o_t=\sigma\left(U_oh_{t-1}+W_ox_t+b_o\right)$
...
$dL=tr\left(\sum_{t=1}^{T}{\left(\frac{\partial L}{\partial c_t}\right)^Tdc_t}\right)=tr\left(\sum_{t=1}^{T}{\left(\frac{\partial L}{\partial c_t}\right)^T{\sigma_{f_t}}^\prime\odot d U_fh_{t-1}\odot c_{t-1}}\right)=tr\left(\sum_{t=1}^{T}{\left(\frac{\partial L}{\partial c_t}\odot c_{t-1}\right)^T{\sigma_{f_t}}^\prime\odot d U_fh_{t-1}}\right)=tr\left(\sum_{t=1}^{T}{\left(\frac{\partial L}{\partial c_t}\odot c_{t-1}\odot{\sigma_{f_t}}^\prime\right)^TdU_fh_{t-1}}\right)=tr\left(\sum_{t=1}^{T}{\left(\left(\frac{\partial L}{\partial c_t}\odot c_{t-1}\odot{\sigma_{f_t}}^\prime\right){h_{t-1}}^T\right)^TdU_f}\right)$

$\frac{\partial L}{\partial U_f}=\sum_{t=1}^{T}{\left(\frac{\partial L}{\partial c_t}\odot c_{t-1}\odot{\sigma_{f_t}}^\prime\right){h_{t-1}}^T}$

同理：

$\frac{\partial L}{\partial W_f}=\sum_{t=1}^{T}{\left(\frac{\partial L}{\partial c_t}\odot c_{t-1}\odot{\sigma_{f_t}}^\prime\right){x_t}^T}$
...
$t$时刻的隐状态$h_t$会通过影响$t$时刻的$z_t$进而损失$L_t$并最终影响总损失$L$。对应的链式传播路径为：

$h_t\rightarrow z_t\rightarrow L_t\rightarrow L$

$t$时刻的隐状态$h_t$会影响$t+1$时刻的输入门$i_{t+1}$、遗忘门$f_{t+1}$和$\widetilde{c_{t+1}}$，进而影响$t+1$时刻的细胞状态$c_t$，最终影响总损失$L$。对应的链式传播路径为：

$h_t\rightarrow i_{t+1},f_{t+1},\widetilde{c_{t+1}}\rightarrow c_{t+1}\rightarrow L$

$t$时刻的隐状态$h_t$会影响$t+1$时刻的输出门$o_{t+1}$，进而影响$t+1$时刻的隐状态$h_{t+1}$，进而影响以后时刻的损失$L_{>t}$，最终影响总损失$L$。对应的链式传播路径为：

$h_t\rightarrow o_{t+1}\rightarrow h_{t+1}\rightarrow L$

可推：

$dc_{t+1}=di_{t+1}\odot\widetilde{c_{t+1}}+i_{t+1}\odot d\widetilde{c_{t+1}}+df_{t+1}\odot c_t={\sigma_{i_{t+1}}}^\prime\odot U_idh_t\odot\widetilde{c_{t+1}}+i_{t+1}\odot\left(1-\widetilde{c_{t+1}}\odot\widetilde{c_{t+1}}\right)\odot U_cdh_t+{\sigma_{f_{t+1}}}^\prime\odot U_fdh_t\odot c_t$

$tr\left(\left(\frac{\partial L}{\partial c_{t+1}}\right)^Tdc_{t+1}\right)=tr\left(\left(\frac{\partial L}{\partial c_{t+1}}\right)^T\left({\sigma_{i_{t+1}}}^\prime\odot U_idh_t\odot\widetilde{c_{t+1}}+i_{t+1}\odot\left(1-\widetilde{c_{t+1}}\odot\widetilde{c_{t+1}}\right)\odot U_cdh_t+{\sigma_{f_{t+1}}}^\prime\odot U_fdh_t\odot c_t\right)\right)=tr\left(\left(\frac{\partial L}{\partial c_{t+1}}\right)^T{\sigma_{i_{t+1}}}^\prime\odot U_idh_t\odot\widetilde{c_{t+1}}\right)+tr\left(\left(\frac{\partial L}{\partial c_{t+1}}\right)^Ti_{t+1}\odot\left(1-\widetilde{c_{t+1}}\odot\widetilde{c_{t+1}}\right)\odot U_cdh_t\right)+tr\left(\left(\frac{\partial L}{\partial c_{t+1}}\right)^T{\sigma_{f_{t+1}}}^\prime\odot U_fdh_t\odot c_t\right)=tr\left(\left({U_i}^T\left(\frac{\partial L}{\partial c_{t+1}}\odot{\sigma_{i_{t+1}}}^\prime\odot\widetilde{c_{t+1}}\right)\right)^Tdh_t\right)+tr\left(\left({U_c}^T\left(\frac{\partial L}{\partial c_{t+1}}\odot i_{t+1}\odot\left(1-\widetilde{c_{t+1}}\odot\widetilde{c_{t+1}}\right)\right)\right)^Tdh_t\right)+tr\left(\left({U_f}^T\left(\frac{\partial L}{\partial c_{t+1}}\odot{\sigma_{f_{t+1}}}^\prime\odot c_t\right)\right)^Tdh_t\right)$

$do_{t+1}={\sigma_{o_{t+1}}}^\prime\odot U_odh_t$

$tr\left(\left(\frac{\partial L}{\partial h_{t+1}}\right)^Tdo_{t+1}\odot t a n h\left(c_{t+1}\right)\right)=tr\left(\left(\frac{\partial L}{\partial h_{t+1}}\right)^T{\sigma_{o_{t+1}}}^\prime\odot U_odh_t\odot t a n h\left(c_{t+1}\right)\right)=tr\left(\left({U_o}^T\left(\frac{\partial L}{\partial h_{t+1}}\odot{\sigma_{o_{t+1}}}^\prime\odot t a n h\left(c_{t+1}\right)\right)\right)^Tdh_t\right)$

$dL=tr\left(\left(\frac{\partial L}{\partial z_t}\right)^Tdz_t\right)+tr\left(\left(\frac{\partial L}{\partial c_{t+1}}\right)^Tdc_{t+1}\right)+tr\left(\left(\frac{\partial L}{\partial h_{t+1}}\right)^Tdh_{t+1}\right)=tr\left(\left(V^T\left(\widehat{y_t}-y_t\right)\right)^Tdh_t\right)+tr\left(\left(\frac{\partial L}{\partial c_{t+1}}\right)^Tdc_{t+1}\right)+tr\left(\left(\frac{\partial L}{\partial h_{t+1}}\right)^Tdo_{t+1}\odot t a n h\left(c_{t+1}\right)\right)$

可得：

$\frac{\partial L}{\partial h_t}=V^T\left(\widehat{y_t}-y_t\right)+{U_i}^T\left(\frac{\partial L}{\partial c_{t+1}}\odot{\sigma_{i_{t+1}}}^\prime\odot\widetilde{c_{t+1}}\right)+{U_c}^T\left(\frac{\partial L}{\partial c_{t+1}}\odot i_{t+1}\odot\left(1-\widetilde{c_{t+1}}\odot\widetilde{c_{t+1}}\right)\right)+{U_f}^T\left(\frac{\partial L}{\partial c_{t+1}}\odot{\sigma_{f_{t+1}}}^\prime\odot c_t\right)+{U_o}^T\left(\frac{\partial L}{\partial h_{t+1}}\odot{\sigma_{o_{t+1}}}^\prime\odot t a n h\left(c_{t+1}\right)\right)$
...
$\delta_h^t=V^T\left(\widehat{y_t}-y_t\right)+{U_i}^T\left(\delta_c^{t+1}\odot{\sigma_{i_{t+1}}}^\prime\odot\widetilde{c_{t+1}}\right)+{U_c}^T\left(\delta_c^{t+1}\odot i_{t+1}\odot\left(1-\widetilde{c_{t+1}}\odot\widetilde{c_{t+1}}\right)\right)+{U_f}^T\left(\delta_c^{t+1}\odot{\sigma_{f_{t+1}}}^\prime\odot c_t\right)+{U_o}^T\left(\delta_h^{t+1}\odot{\sigma_{o_{t+1}}}^\prime\odot t a n h\left(c_{t+1}\right)\right)$

$\delta_h^T=V^T\left(\widehat{y_T}-y_T\right)$

反向传播公式汇总如下：

$\frac{\partial L}{\partial U_i}=\sum_{t=1}^{T}{\left(\delta_c^t\odot\widetilde{c_t}\odot{\sigma_{i_t}}^\prime\right){h_{t-1}}^T}$

$\frac{\partial L}{\partial W_i}=\sum_{t=1}^{T}{\left(\delta_c^t\odot\widetilde{c_t}\odot{\sigma_{i_t}}^\prime\right){x_t}^T}$

$\frac{\partial L}{\partial b_i}=\sum_{t=1}^{T}{\delta_c^t\odot\widetilde{c_t}\odot{\sigma_{i_t}}^\prime}$

$\frac{\partial L}{\partial U_f}=\sum_{t=1}^{T}{\left(\delta_c^t\odot c_{t-1}\odot{\sigma_{f_t}}^\prime\right){h_{t-1}}^T}$

$\frac{\partial L}{\partial W_f}=\sum_{t=1}^{T}{\left(\delta_c^t\odot c_{t-1}\odot{\sigma_{f_t}}^\prime\right){x_t}^T}$

$\frac{\partial L}{\partial b_f}=\sum_{t=1}^{T}{\delta_c^t\odot c_{t-1}\odot{\sigma_{f_t}}^\prime}$

$\frac{\partial L}{\partial U_c}=\sum_{t=1}^{T}{\left(\delta_c^t\odot i_t\odot\left(1-{\widetilde{c_t}}^2\right)\right){h_{t-1}}^T}$

$\frac{\partial L}{\partial W_c}=\sum_{t=1}^{T}{\left(\delta_c^t\odot i_t\odot\left(1-{\widetilde{c_t}}^2\right)\right){x_t}^T}$

$\frac{\partial L}{\partial b_c}=\sum_{t=1}^{T}{\delta_c^t\odot i_t\odot\left(1-{\widetilde{c_t}}^2\right)}$

$\frac{\partial L}{\partial U_o}=\sum_{t=1}^{T}{\left(\delta_h^t\odot t a n h\left(c_t\right)\odot{\sigma_{o_t}}^\prime\right){h_{t-1}}^T}$

$\frac{\partial L}{\partial W_o}=\sum_{t=1}^{T}{\left(\delta_h^t\odot t a n h\left(c_t\right)\odot{\sigma_{o_t}}^\prime\right){x_t}^T}$
